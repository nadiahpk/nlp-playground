...
fname_out_fnc = lambda model_name: f"../../results/compare_vector_embeddings_1983/similarities_hugface_{model_name}.csv" # noqa

# models to try
model_names = ["multi-qa-mpnet-base-dot-v1", "all-MiniLM-L6-v2"]
